...
Namespace WinWebSolution.Module
    ...
    Public Class PhoneNumberNestedListViewController
        ...
        Public Sub New()
            ...
            AddHandler saMasterDetailViewInfoAction.Execute, New SimpleActionExecuteEventHandler(AddressOf saMasterDetailViewInfoAction_Execute)
        End Sub
        ...
        Private Sub MasterDetailViewInfo()
            Console.WriteLine(String.Format("MasterViewId = '{0}'", MasterDetailViewId))
        End Sub
