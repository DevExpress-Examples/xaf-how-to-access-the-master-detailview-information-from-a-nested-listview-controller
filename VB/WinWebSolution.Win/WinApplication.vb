...
Namespace WinWebSolution.Win
    ...
    Partial Public Class WinWebSolutionWindowsFormsApplication
        ...
        End Sub
        Private Sub WinWebSolutionWindowsFormsApplication_CustomizeLanguagesList(ByVal sender As Object, ByVal e As CustomizeLanguagesListEventArgs) Handles Me.CustomizeLanguagesList
