...
Namespace AccessMasterObjectSolution.Web
    ...
    Partial Public Class AccessMasterObjectSolutionAspNetApplication
        ...
        End Function
        Private Sub AccessMasterObjectSolutionAspNetApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles Me.DatabaseVersionMismatch
#If EASYTEST Then
            e.Updater.Update()
            e.Handled = True
#Else
...
'ORIGINAL LINE: this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.AccessMasterObjectSolutionAspNetApplication_DatabaseVersionMismatch);
